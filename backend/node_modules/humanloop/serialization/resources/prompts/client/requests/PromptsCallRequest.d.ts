...
export declare const PromptsCallRequest: core.serialization.Schema<serializers.PromptsCallRequest.Raw, Omit<Humanloop.PromptsCallRequest, "versionId" | "environment">>;
