...
export declare const DatasetRequest: core.serialization.Schema<serializers.DatasetRequest.Raw, Omit<Humanloop.DatasetRequest, "versionId" | "environment" | "includeDatapoints">>;
