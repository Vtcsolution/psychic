...
exports.PromptLogResponse = void 0;
const serializers = __importStar(require("../index"));
const core = __importStar(require("../../core"));
const ChatMessage_1 = require("./ChatMessage");
const PromptLogResponseToolChoice_1 = require("./PromptLogResponseToolChoice");
const LogStatus_1 = require("./LogStatus");
exports.PromptLogResponse = core.serialization.object({
    outputMessage: core.serialization.property("output_message", ChatMessage_1.ChatMessage.optional()),
    ...
    messages: core.serialization.list(ChatMessage_1.ChatMessage).optional(),
    toolChoice: core.serialization.property("tool_choice", PromptLogResponseToolChoice_1.PromptLogResponseToolChoice.optional()),
    ...
    providerRequest: core.serialization.property("provider_request", core.serialization.record(core.serialization.string(), core.serialization.unknown()).optional()),
    providerResponse: core.serialization.property("provider_response", core.serialization.record(core.serialization.string(), core.serialization.unknown()).optional()),
    ...
    logStatus: core.serialization.property("log_status", LogStatus_1.LogStatus.optional()),
    ...
    evaluatorLogs: core.serialization.property("evaluator_logs", core.serialization.list(core.serialization.lazyObject(() => serializers.EvaluatorLogResponse))),
    ...
    traceChildren: core.serialization.property("trace_children", core.serialization.list(core.serialization.lazy(() => serializers.LogResponse)).optional()),
});
