...
export declare const EvaluatorRequestSpec: core.serialization.Schema<serializers.EvaluatorRequestSpec.Raw, Humanloop.EvaluatorRequestSpec>;
export declare namespace EvaluatorRequestSpec {
    type Raw = LlmEvaluatorRequest.Raw | CodeEvaluatorRequest.Raw | HumanEvaluatorRequest.Raw | ExternalEvaluatorRequest.Raw;
}
